...
class MyOVBox(OVBox):
	def __init__(self):
		...
		self.combinedData = numpy.zeros((1, 229))	
	...
	def uninitialize(self):
		...
		savetxt('d:\\table_of_flashes_1_to_12_228_' + fileName + '.csv', self.combinedData, delimiter=',')
